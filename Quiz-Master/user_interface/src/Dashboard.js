    ...
    >
      ...
      <Container className="mt-3" style={{ maxWidth: "1000px" }}>
        ...
        <div className="text-center mb-5">
          <h1 className="fw-semibold text-white welcome-message">
            👋 Welcome, Teacher!
          </h1>
        </div>
        ...
        <Row>
          {quizzes.map((quiz, index) => {
            const randomImage = quizImages[index % quizImages.length]; // Consistent per card
